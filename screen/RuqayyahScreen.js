...
class RuqayyahScreen extends React.Component{
...
renderDetail(){
  return this.state.display.map(result =>
    ...
    render(){
        return(
            <ScrollView style={{flex:1, padding:10, backgroundColor:'#FDCA2E'}}>
                <View style={styles.container}>
                    <Image source={require('../img/ruqayyah.jpg')} style={styles.img}/>
                    <Text style={styles.Titletext}>Mahallah Ruqayyah</Text>
                </View>

                <View style={styles.container}>
          
                     <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.facebook.com/mahallahruqayyah')}>
                        <Text style={styles.fontStyle}>
                         <Image source={require('../img/icon2/FB.png')} style={styles.img1}/> 
                            Mahallah Ruqayyah</Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.instagram.com/ruqayyahians/?hl=en')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/IG.png')} style={styles.img1}/> 
                            @ruqayyahians </Text>
                    </TouchableNativeFeedback>
          
                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://twitter.com/ruqayyahvoice')}>
                        <Text style={styles.fontStyle}>
                    ...
                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.google.com/maps/place/Mahallah+Ruqayyah/@3.259798,101.7309583,17z/data=!3m1!4b1!4m5!3m4!1s0x31cc38c884b5ed69:0x3f2b94b17a9ff79d!8m2!3d3.259798!4d101.733147')}>
                        <Text style={styles.fontStyle}>
