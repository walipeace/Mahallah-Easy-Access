...
renderDetail(){
  return this.state.display.map(result =>
    ...
    render(){
        return(
            <ScrollView style={{flex:1, padding:10, backgroundColor:'#699CFC'}}>
                <View style={styles.container}>
                    <Image source={require('../img/siddiq.png')} style={styles.img}/>
                    <Text style={styles.Titletext}>Mahallah Siddiq</Text>
                </View>

                <View style={styles.container}>
          
                     <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.facebook.com/mahallah.assiddiq')}>
                        <Text style={styles.fontStyle}>
                         <Image source={require('../img/icon2/FB.png')} style={styles.img1}/> 
                         Mahallah As-Siddiq</Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.instagram.com/mrcsiddiqiium/?hl=en')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/IG.png')} style={styles.img1}/> 
                        @mrcsiddiqiium </Text>
                    </TouchableNativeFeedback>
          
                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://twitter.com/mrcassiddiq')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/twit.png')} style={styles.img1}/>
                        @mrcassiddiq </Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('tel:+60364214063')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/phone1.png')} style={styles.img1}/>
                         03-6421 4063/4062/4061 </Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.google.com/maps/place/Mahallah+Siddiq/@3.2473247,101.7370262,17z/data=!3m1!4b1!4m5!3m4!1s0x31cc38e851de5943:0x5c5e6a6be455728!8m2!3d3.2473247!4d101.7392149')}>
                        <Text style={styles.fontStyle}>
