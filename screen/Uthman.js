...
renderDetail(){
  return this.state.display.map(result =>
    ...
    render(){
        return(
            <ScrollView style={{flex:1, padding:10, backgroundColor:'#006994'}}>
                <View style={styles.container}>
                    <Image source={require('../img/uthman.jpg')} style={styles.img}/>
                    <Text style={styles.Titletext}>Mahallah Uthman Ibn Affan</Text>
                </View>

                <View style={styles.container}>
          
                     <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.facebook.com/mahallahuthman.ibnaffan')}>
                        <Text style={styles.fontStyle}>
                         <Image source={require('../img/icon2/FB.png')} style={styles.img1}/> 
                         Mahallah Uthman Ibn Affan</Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.instagram.com/mahallah_uthman/?hl=en')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/IG.png')} style={styles.img1}/> 
                        @mahallah_uthman </Text>
                    </TouchableNativeFeedback>
