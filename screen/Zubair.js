...
class Zubair extends React.Component{
        ...
        return(
            <ScrollView style={{flex:1, padding:10, backgroundColor:'#800000'}}>
                <View style={styles.container}>
                    <Image source={require('../img/zubair.jpg')} style={styles.img}/>
                    <Text style={styles.Titletext}>Mahallah Zubair Al-Awwam</Text>
                </View>

                <View style={styles.container}>
          
                     <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.facebook.com/MahallahZubair')}>
                        <Text style={styles.fontStyle}>
                         <Image source={require('../img/icon2/FB.png')} style={styles.img1}/> 
                         Mahallah Zubair Al-Awwam</Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.instagram.com/mahallahzubairiium/?hl=en')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/IG.png')} style={styles.img1}/> 
                        @mahallahzubairiium </Text>
                    </TouchableNativeFeedback>
          
                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://twitter.com/Mahallah_Zubair')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/twit.png')} style={styles.img1}/>
                        @Mahallah_Zubair </Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('tel:+60364215968')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/phone1.png')} style={styles.img1}/>
                         03-6421 5968/5969/5967 </Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.google.com/maps/place/Mahallah+Zubair+Al-Awwam/@3.2465761,101.7337206,17z/data=!3m1!4b1!4m5!3m4!1s0x31cc38ebc4fcc0c7:0x76b15c711ab1f45!8m2!3d3.2465761!4d101.7359093')}>
                        <Text style={styles.fontStyle}>
