...
class Faruq extends React.Component{
...
renderDetail(){
  return this.state.display.map(result =>
    ...
    render(){
        return(
            <ScrollView style={{flex:1, padding:10, backgroundColor:'#A9A9A9'}}>
                <View style={styles.container}>
                    <Image source={require('../img/faruq.jpg')} style={styles.img}/>
                    <Text style={styles.Titletext}>Mahallah Faruq</Text>
                </View>

                <View style={styles.container}>
          
                     <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.facebook.com/mahallah.alfaruq')}>
                        <Text style={styles.fontStyle}>
                         <Image source={require('../img/icon2/FB.png')} style={styles.img1}/> 
                         Mahallah Al-Faruq</Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.instagram.com/mahallahfaruq/?hl=en')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/IG.png')} style={styles.img1}/> 
                        @mahallahfaruq </Text>
                    </TouchableNativeFeedback>
          
                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://twitter.com/MahallahFaruq')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/twit.png')} style={styles.img1}/>
                        @MahallahFaruq </Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('tel:+60364214121')}>
                        <Text style={styles.fontStyle}>
                        <Image source={require('../img/icon2/phone1.png')} style={styles.img1}/>
                         03-6421 4121/4122/4120 </Text>
                    </TouchableNativeFeedback>

                    <TouchableNativeFeedback onPress={() => Linking.openURL('https://www.google.com/maps/place/Mahallah+Faruq/@3.248576,101.7400305,15z/data=!4m5!3m4!1s0x0:0x2fee3dbfc62b32f6!8m2!3d3.248576!4d101.7400305')}>
                        <Text style={styles.fontStyle}>
